...
const Ui = ()=>{ 
    ...
    <div style={purpleShadow} className=" rounded-2xl shadow-2xl h-[80vh] w-[918px] flex flex-col gap-8 py-10">
        ...
        <div className="flex items-center justify-center gap-5">
          <button onClick={() => copyToClipboard(password)} className="text-white font-bold bg-[rgb(23,93,220)] w-[400px] text-[18px] py-2 rounded-full">Copy to Clipboard</button>
          <button onClick={generatePassword} className="text-white font-bold bg-[rgb(23,93,220)] w-[400px] text-[18px] py-2 rounded-full">Regenerate Password</button>
        </div>
